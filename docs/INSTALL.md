# Download and install Mac Duo Private 0.4.9
...
6. Click its laptop menu-bar icon. Confirm **Version 0.4.9** appears and **Lid animation** is on. There is no normal Dock icon.
